...
export const RUSTDESK_SERVER_PUBKEY = "PacuDs55dwuqUWY2NBrT2Jv46yI27dm0oaQKGhCMqBQ=";

// Contact email
export const CONTACT_EMAIL = "contact@davepinto.dev";
export const CONTACT_DISPLAY = "davepinto.dev";
